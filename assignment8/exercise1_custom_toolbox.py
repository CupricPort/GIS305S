...
def buffer_layer(input_gdb, input_layer, dist):
    ...
    output_layer = r"C:\Users\benlj\OneDrive\Documents\School\SpringSemester2025\ProgrammingForGIS\ProgrammingLabs\ProgrammingLabs.gdb\\" + input_layer + "_buf"
...
def main():
    ...
    # Buffer cities
    input_gdb = r"C:\Users\benlj\OneDrive\Documents\School\SpringSemester2025\ProgrammingForGIS\ProgrammingLabs\ProgrammingLabs.gdb\\"
    ...
    map_doc.addDataFromPath(rf"C:\Users\benlj\OneDrive\Documents\School\SpringSemester2025\ProgrammingForGIS\ProgrammingLabs\ProgrammingLabs.gdb\{intersect_lyr_name}")
